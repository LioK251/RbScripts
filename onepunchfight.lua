...
do 
        ...
        local dropdown = {} do 
            ...
            dropdown.open = function(self) 
                ...
                tween(self.instances.controlFrame, {
                    Size = UDim2.new(1, 0, 0, 68+20) -- 68+20
                }, 0.2, 1)
            end
            ...
            dropdown.refresh = function(main, self)
            ...
            dropdown.addOption = function(ops, self)
                local clickSensor = Instance.new('TextButton') do 
                    clickSensor.BackgroundTransparency = 1
                    clickSensor.Name = '#click-sensor'
                    clickSensor.Size = UDim2.new(1, 0, 0, 20)
            ...
            dropdown.removeOption = function(option, self)
    ...
    do 
        local multidropdown = {} do 
            ...
            multidropdown.getList = function(self)
            ...
            multidropdown.setOptions = function(self, newOptions) 
                for i, opt in ipairs(self.options) do
                    self:removeOption(opt)
                end
            ...
            elemClasses.section.addMultiDropdown = function(self, settings) 
                if (not typeof(settings) == 'table') then
                    return error('expected type table for settings', 2) 
                end
